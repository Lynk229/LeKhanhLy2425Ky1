...
namespace LeKhanhLy423.Controllers
{
    public class NhanvienController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IDNV,Fullname,Tuoi,Chucvu")] Nhanvien nhanvien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IDNV,Fullname,Tuoi,Chucvu")] Nhanvien nhanvien)
        {
            if (id != nhanvien.IDNV)
            {
                return NotFound();
